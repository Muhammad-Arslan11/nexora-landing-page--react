...
function About() {
  ...
  return (
    <div id="about" className="w-full h-auto flex flex-col justify-between items-center lg:px-[80px] lg:py-[80px] px-[60px] py-[20px]">
      <div id="top-box" className="w-full flex lg:flex-row flex-col justify-between items-center gap-[60px]">
        <div className="lg:w-[60px] flex flex-col justify-center items-start gap-[18px]">
      ...
      <div id="bottom-box" className="w-full flex lg:flex-row flex-col justify-between items-center gap-[80px]">
        ...
        <div id="content-box" className="lg:w-[60%] w-full flex flex-col justify-between items-center gap-[60px]">
